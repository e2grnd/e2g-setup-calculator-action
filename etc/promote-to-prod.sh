...
----- START deep-thought-calculator -----"; git -C deep-thought-calculator checkout release/prod && git -C deep-thought-calculator pull && git -C deep-thought-calculator merge -m'prod release' release/stage && git -C deep-thought-calculator push
echo "
...
----- START in-sight-calculator -----"; git -C in-sight-calculator checkout release/prod && git -C in-sight-calculator pull && git -C in-sight-calculator merge -m'prod release' release/stage && git -C in-sight-calculator push
echo "
...
----- START ncpv-nozzle-fea-calculator -----"; git -C ncpv-nozzle-fea-calculator checkout release/prod && git -C ncpv-nozzle-fea-calculator pull && git -C ncpv-nozzle-fea-calculator merge -m'prod release' release/stage && git -C ncpv-nozzle-fea-calculator push
echo "
...
----- START nozzle-fea-calculator -----"; git -C nozzle-fea-calculator checkout release/prod && git -C nozzle-fea-calculator pull && git -C nozzle-fea-calculator merge -m'prod release' release/stage && git -C nozzle-fea-calculator push
echo "
...
----- START pvelite-converter-calculator -----"; git -C pvelite-converter-calculator checkout release/prod && git -C pvelite-converter-calculator pull && git -C pvelite-converter-calculator merge -m'prod release' release/stage && git -C pvelite-converter-calculator push
echo "
...
----- START rbi-plus-calculator -----"; git -C rbi-plus-calculator checkout release/prod && git -C rbi-plus-calculator pull && git -C rbi-plus-calculator merge -m'prod release' release/stage && git -C rbi-plus-calculator push
echo "

----- START sage-api-worker-calculator -----"; git -C sage-api-worker-calculator checkout release/prod && git -C sage-api-worker-calculator pull && git -C sage-api-worker-calculator merge -m'prod release' release/stage && git -C sage-api-worker-calculator push
echo "
...
----- START sandman-calculator -----"; git -C sandman-calculator checkout release/prod && git -C sandman-calculator pull && git -C sandman-calculator merge -m'prod release' release/stage && git -C sandman-calculator push
echo "
...
----- START snooze-fest-calculator -----"; git -C snooze-fest-calculator checkout release/prod && git -C snooze-fest-calculator pull && git -C snooze-fest-calculator merge -m'prod release' release/stage && git -C snooze-fest-calculator push
echo "

----- START sphere-legs-fea-calculator -----"; git -C sphere-legs-fea-calculator checkout release/prod && git -C sphere-legs-fea-calculator pull && git -C sphere-legs-fea-calculator merge -m'prod release' release/stage && git -C sphere-legs-fea-calculator push
echo "
...
----- START tank-sight-calculator -----"; git -C tank-sight-calculator checkout release/prod && git -C tank-sight-calculator pull && git -C tank-sight-calculator merge -m'prod release' release/stage && git -C tank-sight-calculator push
echo "
...
----- START van-winkgo-calculator -----"; git -C van-winkgo-calculator checkout release/prod && git -C van-winkgo-calculator pull && git -C van-winkgo-calculator merge -m'prod release' release/stage && git -C van-winkgo-calculator push
echo "
